        ...
        <div class="row justify-content-center">
          <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 order-lg-2 offset-xl-1 mb-4">
            <div class="img-wrap text-center text-md-left" data-aos="fade-up" data-aos-delay="100">
              <div class="img">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/img_v_3.jpg" alt="circle image" class="img-fluid">
              </div>
            </div>
          </div>
      ...
      <div class="row gy-4 justify-content-center">
        ...
        <div class="col-lg-5">
          <div class="images-overlap">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/img_v_1.jpg" alt="student" class="img-fluid img-1" data-aos="fade-up">
          </div>
        </div>
      ...
      <div class="row gap-x-lg-4 justify-content-between">
        ...
        <div class="col-lg-8">
          <div class="swiper init-swiper-tabs">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/img_h_1.jpg" alt="Image" class="img-fluid">
                <div class="p-4">
              ...
              <div class="swiper-slide">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/img_h_2.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="swiper-slide">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/img_h_3.jpg" alt="Image" class="img-fluid">
              </div>
              <div class="swiper-slide">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/img_h_4.jpg" alt="Image" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="swiper init-swiper">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="testimonial mx-auto">
                  <figure class="img-wrap">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/testimonials/testimonials-1.jpg" alt="Image" class="img-fluid">
                  </figure>
              ...
              <div class="swiper-slide">
                <div class="testimonial mx-auto">
                  <figure class="img-wrap">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/testimonials/testimonials-2.jpg" alt="Image" class="img-fluid">
                  </figure>
              ...
              <div class="swiper-slide">
                <div class="testimonial mx-auto">
                  <figure class="img-wrap">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/testimonials/testimonials-3.jpg" alt="Image" class="img-fluid">
                  </figure>

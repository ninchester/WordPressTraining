			...
			<div class="col-lg-12 col-sm-12 col-md-12 slider-wrap">
					...
					<div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/slider/slider1.jpg" alt="" class="img-fluid">
							</a>
						</div>
				...
				<div class="slider-item">
					<div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/slider/slider2.jpg" alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
				...
				<div class="slider-item">
					<div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/slider/slider3.jpg" alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f1.jpg" alt="" class="img-fluid w-100">
							</a>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f2.jpg" alt="" class="img-fluid w-100">
							</a>
							<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Lifestyle</span>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f3.jpg" alt="" class="img-fluid w-100">
							</a>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f4.jpg" alt="" class="img-fluid w-100">
							</a>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f5.jpg" alt="" class="img-fluid w-100">
							</a>
							<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f6.jpg" alt="" class="img-fluid w-100">
							</a>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f7.jpg" alt="" class="img-fluid w-100">
							</a>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f8.jpg" alt="" class="img-fluid w-100">
							</a>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f9.jpg" alt="" class="img-fluid w-100">
							</a>
							<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f10.jpg" alt="" class="img-fluid w-100">
							</a>
							<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Experience</span>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f11.jpg" alt="" class="img-fluid w-100">
							</a>
							<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Travel</span>
					...
					<div class="col-lg-3 col-md-6">
						<article class="post-grid mb-5">
							<a class="post-thumb mb-4 d-block" href="blog-single.html">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/news/f12.jpg" alt="" class="img-fluid w-100">
							</a>
							<span class=" cat-name text-color font-sm font-extra text-uppercase letter-spacing">Lifestyle</span>
